...
// Global monkey-patch for getComputedStyle to convert oklch colors to rgb
// This prevents html2canvas / html2pdf from crashing with: "Attempting to parse an unsupported color function 'oklch'"
if (typeof window !== 'undefined' && typeof window.getComputedStyle === 'function') {
  ...
  const convertOklchToRgb = (val: string): string => {
    ...
    return val.replace(/oklch\(([^)]+)\)/g, (match, contents) => {
      try {
