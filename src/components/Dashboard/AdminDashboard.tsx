...
import { ClientData, LaudoData, ChecklistData, EquipmentData, LaudoStatus, getLaudoVisualStatus } from '../../types';
...
export default function AdminDashboard({
  ...
  const expirations = laudos.filter(l => getLaudoVisualStatus(l).key === 'vencido');
