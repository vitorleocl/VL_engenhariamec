              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div className="space-y-1 col-span-2 flex items-center gap-2 pt-2">
                  <input
                    ...
                    onChange={e => handleFieldChange("blankSignature", e.target.checked)}
                    className="rounded border-slate-300 dark:border-slate-700 text-emerald-600 focus:ring-emerald-500"
                  />
                  <label htmlFor="blankSignature" className="text-xs font-semibold text-slate-700 dark:text-slate-300 cursor-pointer select-none">
          ...
          <div className="bg-slate-100 dark:bg-slate-950 p-4 rounded-3xl border dark:border-slate-850 shadow-inner max-h-[85vh] overflow-y-auto">
            ...
            >
              ...
              <div className="space-y-8 pt-12 page-break-before-always">
                ...
                {/* Signatures block */}
                <div className="pt-8 grid grid-cols-2 gap-8 text-center text-[10px] items-end">
                  <div className="space-y-4">
                    <ReportSignature 
                      isBlank={laudoParams.blankSignature} 
                      engName={laudoParams.engName} 
                      engCrea={`CREA-PE: ${laudoParams.engCrea}`} 
                      artNumber={laudoParams.artNumber} 
                    />
                  </div>
